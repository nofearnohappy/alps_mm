...
)
{
    ...
    sensorTMPara.TM_Line        = 4500;//48;
    sensorTMPara.TM_Pixel       = 6500;//48;
    ...
    if(currSensorDev & SENSOR_DEV_MAIN ) {
        ...
        // video mode need check framerate support
        if((halSensorIFParam[0].scenarioId == 2) &&
            ((halSensorIFParam[idx].framerate != 15) || (halSensorIFParam[idx].framerate != 30)))
        {
            data1 = halSensorIFParam[0].scenarioId;
            ret = pSensorDrv->sendCommand(SENSOR_MAIN, CMD_SENSOR_GET_DEFAULT_FRAME_RATE_BY_SCENARIO, (MUINTPTR)&data1, (MUINTPTR)&data2);
            halSensorIFParam[idx].framerate = data2;
    ...
    if(currSensorDev & SENSOR_DEV_SUB ) {
        ...
        switch(halSensorIFParam[1].scenarioId) {
            case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
                ...
                break;
            case SENSOR_SCENARIO_ID_NORMAL_CAPTURE:
                sensorPara[1].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM1;
                break;
            case SENSOR_SCENARIO_ID_NORMAL_VIDEO:
                sensorPara[1].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM2;
                break;
            case SENSOR_SCENARIO_ID_SLIM_VIDEO1:
                sensorPara[1].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM3;
                break;
            case SENSOR_SCENARIO_ID_SLIM_VIDEO2:
                sensorPara[1].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM4;
                break;
            default:
                sensorPara[1].u1MIPIDataSettleDelay = sensorDrvInfo[0].MIPIDataLowPwr2HighSpeedSettleDelayCount;
                break;
        }
    ...
    if(currSensorDev & SENSOR_DEV_MAIN_2 ) {
        ...
        switch(halSensorIFParam[2].scenarioId) {
            case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
                sensorPara[2].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM0;
                break;
            case SENSOR_SCENARIO_ID_NORMAL_CAPTURE:
                sensorPara[2].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM1;
                break;
            case SENSOR_SCENARIO_ID_NORMAL_VIDEO:
                sensorPara[2].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM2;
                break;
            case SENSOR_SCENARIO_ID_SLIM_VIDEO1:
                sensorPara[2].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM3;
                break;
            case SENSOR_SCENARIO_ID_SLIM_VIDEO2:
                sensorPara[2].u1MIPIDataSettleDelay=sensorDrvInfo[0].MIPIDataLowPwr2HSSettleDelayM4;
                break;
            default:
                sensorPara[2].u1MIPIDataSettleDelay = sensorDrvInfo[0].MIPIDataLowPwr2HighSpeedSettleDelayCount;
                break;
        }
    ...
    MUINTPTR arg3)
{
    ...
    case SENSOR_CMD_GET_SENSOR_PDAF_CAPACITY:
        ...
        pSensorDrv->sendCommand((SENSOR_DEV_ENUM)sensorDevId,cmdId, arg1, arg2, arg3);
        break;
    case SENSOR_CMD_GET_SENSOR_PDAF_EEPROM_DATASIZE:
        cmdId = CMD_SENSOR_GET_SENSOR_PDAF_EEPROM_DATASIZE;
        pSensorDrv->sendCommand((SENSOR_DEV_ENUM)sensorDevId,cmdId, arg1);
        break;
    //0x3000
