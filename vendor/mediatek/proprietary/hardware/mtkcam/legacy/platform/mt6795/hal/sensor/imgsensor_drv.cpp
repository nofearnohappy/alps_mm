...
//#define SENDCMD_LOG // Open sendcommand log, for test only
    ...
    case CMD_SENSOR_GET_SENSOR_VC_INFO:
     ...
     case CMD_SENSOR_GET_SENSOR_PDAF_EEPROM_DATASIZE:
        FeatureId = SENSOR_FEATURE_GET_SENSOR_PDAF_EEPROM_DATASIZE;
        FeatureParaLen = sizeof(MUINTPTR);
        pFeaturePara = (MUINT8*)parg1;
        LOG_MSG("[CMD_SENSOR_GET_SENSOR_PDAF_EEPROM_DATASIZE] parg1 = %p \n", parg1);
        break;
