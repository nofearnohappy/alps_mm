...
init()
{
    ...
    //
    {
        ...
        else
        {
            ...
            {
                MY_LOGD("devinfo_data(0x%08X)",devinfo_data);
                if((devinfo_data & 0x7) != 0x0)
                {
                    mbFullFuncChip = MFALSE;
                }
            }
            else
            {
...
sendCommand(int32_t cmd, int32_t arg1, int32_t arg2)
{
    ...
    switch  (cmd)
    {
        ...
        {
            CAM_LOGD("CAMERA_CMD_START_GD_PREVIEW\n");
            if(mpPass2Node)
            {
        ...
        {
            CAM_LOGD("CAMERA_CMD_CANCEL_GD_PREVIEW\n");
            if(mpPass2Node)
            {
        ...
        {
            CAM_LOGD("CAMERA_CMD_START_SD_PREVIEW\n");
            if(mpPass2Node)
            {
        ...
        {
            CAM_LOGD("CAMERA_CMD_CANCEL_SD_PREVIEW\n");
            if(mpPass2Node)
            {
