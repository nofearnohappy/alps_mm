...
/*IMX*/
    ...
    RAW_INFO(IMX166_SENSOR_ID, SENSOR_DRVNAME_IMX166_MIPI_RAW,NULL),
#endif
...
/*OV (OmniVision)*/
    ...
    RAW_INFO(OV8858TRULY_SENSOR_ID, SENSOR_DRVNAME_OV8858TRULY_MIPI_RAW,NULL),
#endif
#if defined(OV8858SUNNY_MIPI_RAW)
    RAW_INFO(OV8858SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV8858SUNNY_MIPI_RAW,NULL),
#endif
...
///////////RN2_START///////////
    ...
    RAW_INFO(OV5670_2ND_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_2ND_MIPI_RAW, NULL),
#endif
#if defined(OV5670_FLT_2ND_MIPI_RAW)
    RAW_INFO(OV5670_FLT_2ND_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_FLT_2ND_MIPI_RAW, NULL),
#endif
#if defined(S5K3M2_MIPI_RAW)
    RAW_INFO(S5K3M2_SENSOR_ID, SENSOR_DRVNAME_S5K3M2_MIPI_RAW, S5K3M2MIPIRAW_CAM_CALGetCalData),
#endif
#if defined(S5K3M2_2ND_MIPI_RAW)
    RAW_INFO(S5K3M2_2ND_SENSOR_ID, SENSOR_DRVNAME_S5K3M2_2ND_MIPI_RAW, S5K3M2_2ND_MIPIRAW_CAM_CALGetCalData),
#endif
///////////RN2_END///////////
///////////RN3_START///////////
#if defined(OV13853_MIPI_RAW)
    RAW_INFO(OV13853_SENSOR_ID, SENSOR_DRVNAME_OV13853_MIPI_RAW,OV13853MIPIRAWCAM_CALGetCalData),
#endif
#if defined(OV13853_MIPI_RAW_MTS)
    RAW_INFO(OV13853_SENSOR_ID_MTS, SENSOR_DRVNAME_OV13853_MIPI_RAW_MTS,OV13853MIPIRAWCAM_CALGetCalData),
#endif
...
/*GC*/
    ...
    RAW_INFO(GC5024MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5024_MIPI_RAW,NULL),
#endif
#if defined(GC5005_MIPI_RAW)
    RAW_INFO(GC5005MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5005_MIPI_RAW,NULL),
#endif
