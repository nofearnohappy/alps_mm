...
#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (143360) // 140K bytes //check ok 
#define MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE          (25600) // 25K bytes   //check ok
...
#define MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE      (4864) //(5120)
...
#define MAXIMUM_CAMERA_SHADING_SIZE  (860000) //(1050652)
