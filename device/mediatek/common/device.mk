...
ifeq ($(strip $(OPTR_SPEC_SEG_DEF)),NONE)
  ifneq ($(strip $(MTK_BSP_PACKAGE)), yes)
    ifneq ($(strip $(MTK_A1_FEATURE)), yes)
# Vanzo:tanglei on: Tue, 29 Dec 2015 21:51:43 +0800
...
# Vanzo:yucheng on: Fri, 15 Jan 2016 15:48:32 +0800
# Remove 3rd party App
...
ifeq ($(strip $(MTK_HOTKNOT_SUPPORT)), yes)
  ...
  PRODUCT_PROPERTY_OVERRIDES += ro.mediatek.hotknot.module=GT9XX
endif
