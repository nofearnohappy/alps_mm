...
public class NetworkTemplate implements Parcelable {
     ...
     */
    /**
     * @return MatchSubscriberIds.
     * MatchSubscriberIds are designed to match several "merged" subscribers.
     * These are the subscribers that should be considered to match this template.
     */
    ...
    /**
     * @param subscriberId that need to be matched for the template.
     * Add subscriberId into MatchSubscriberIds for matching multiple subscribers.
     */
    public boolean addMatchSubscriberId(String subscriberId) {
