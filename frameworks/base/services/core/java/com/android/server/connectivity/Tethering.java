...
public class Tethering extends BaseNetworkObserver {
    ...
    private void showTetheredNotification(int icon, String type) {
        ...
        synchronized (Tethering.this.mNotificationSync) {
             ...
             Notification.InboxStyle style = new Notification.InboxStyle(mTetheredNotificationBuilder).addLine(message_1);
    ...
    private void updateTetheredNotification() {
        ...
        synchronized (Tethering.this.mNotificationSync) {
              NotificationManager notificationManager =
                      (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
              WifiManager mgr = (WifiManager) mContext.getSystemService(Context.WIFI_SERVICE);
              if (notificationManager == null || mgr == null || mTetheredNotificationBuilder == null) {
                  return;
              }
              List<HotspotClient> clients = mgr.getHotspotClients();
              int connected = 0;
                ...
                if (mMyUpstreamIfaceNameIpv6 != null) {
                    try {
                        ...
                        if (mPreferredUpstreamMobileApn == ConnectivityManager.TYPE_MOBILE_DUN) {
                            if (mMyUpstreamIfaceNameIpv6 != null &&
                                !mMyUpstreamIfaceNameIpv6.equals(mWifiIface)) {
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case CMD_TETHER_CONNECTION_CHANGED:
                        ...
                        /** @} */
                        /** M: ALPS00609719,ALPS00652865
                               re-set throttle value after hotspot re-enabled */
                        if (isWifi(mIfaceName)) {
                            ...
                            if (enable) {
                                try {
                                    ...
                                    Log.d(TAG, "[ISM_Tethered] wifi hotspot bandwidth is enable:"
                                        + rx + "/" + tx);
                                } catch (Exception e) {
    ...
    class TetherMasterSM extends StateMachine {
        ...
        class TetherMasterUtilState extends State {
            ...
            protected boolean turnOnUpstreamMobileConnection(int apnType) {
                ...
                Log.i(TAG, "[MSM_TetherModeAlive][" + mName + "] startUsingNetworkFeature result="
                    + result);
                switch (result) {
            ...
            protected boolean turnOffUpstreamMobileConnection() {
                ...
                Log.i(TAG, "[MSM_TetherModeAlive][" + mName + "] mMobileApnReserved:"
                    + mMobileApnReserved);
            ...
            protected void chooseUpstreamType(boolean tryCell) {
                ...
                if (upType == ConnectivityManager.TYPE_NONE) {
                    ...
                    Log.d(TAG, "tryCell = " + tryCell + ",mPreferredUpstreamMobileApn = "
                        + mPreferredUpstreamMobileApn);
                    if ((tryCell == TRY_TO_SETUP_MOBILE_CONNECTION) &&
                        (checkDataEnabled(ConnectivityManager.TYPE_MOBILE_DUN) == true) &&
            ...
            protected void notifyTetheredOfNewUpstreamIface(String ifaceName) {
                if (DBG) Log.i(TAG, "[MSM_TetherModeAlive][" + mName
                    + "] notifying tethered with iface =" + ifaceName);
                mUpstreamIfaceName = ifaceName;

                /** M: for bug solving @{ */
                for (Object o : mNotifyList) {
                    TetherInterfaceSM sm = (TetherInterfaceSM) o;
                    if (ifaceName != null && sm.mMyUpstreamIfaceName != null &&
                        !ifaceName.equals(sm.mMyUpstreamIfaceName)) {
