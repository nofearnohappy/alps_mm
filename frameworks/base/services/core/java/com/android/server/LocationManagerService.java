...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    private void loadProvidersLocked() {
        ...
        */
        ...
        LocationProviderProxy networkProvider = LocationProviderProxy.createAndDelayBind(
                mContext,
        ...
        // M: try to bind to cn network provider
        if (networkProvider == null) {
            networkProvider = LocationProviderProxy.createAndDelayBind(
                    mContext,
                    LocationManager.NETWORK_PROVIDER,
                    NETWORK_LOCATION_SERVICE_ACTION,
                    com.android.internal.R.bool.config_enableNetworkLocationOverlay,
                    com.android.internal.R.string.config_networkLocationProviderPackageName,
                    com.mediatek.internal.R.array.config_cnNetworkLocationProviderPackageNames,
                    mLocationHandler);
        }
        if (networkProvider != null) {
    ...
    private void reBindNetworkProviderLock(boolean bindGmsPackage) {
        ...
        int locationProviderPackageNamesId = 0;
        if (bindGmsPackage) {
            locationProviderPackageNamesId =
                    com.android.internal.R.array.config_locationProviderPackageNames;
        } else {
            locationProviderPackageNamesId =
                    com.mediatek.internal.R.array.config_cnNetworkLocationProviderPackageNames;
        ...
        if (networkProvider != null) {
            Log.d(TAG, "Successfully bind new package");

            //unbind previous network provider
            if (previousNlp != null) {
                LocationProviderProxy.close(previousNlp);
                mRealProviders.remove(LocationManager.NETWORK_PROVIDER);
