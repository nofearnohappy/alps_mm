...
class BluetoothManagerService extends IBluetoothManager.Stub {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_BLUETOOTH_SERVICE_CONNECTED:
                {
                    ...
                    synchronized(mConnection) {
                        ...
                        try {
                            boolean enableSspDebugMode = (Settings.Secure.getInt(mContentResolver,
                                Settings.Secure.BLUETOOTH_SSP_DEBUG_MODE, 0) == 1);
                            if (!mBluetooth.configSspDebugMode(enableSspDebugMode)) {
                                Log.e(TAG,"IBluetooth.configSspDebugMode return false");
                            }
                        } catch (RemoteException e) {
                            Log.e(TAG,"Unable to call configSspDebugMode", e);
                        }
    ...
    private boolean waitForBleOn() {
        ...
        Log.e(TAG,"waitForBleOn time out");
        return false;
    }
    /// @}
