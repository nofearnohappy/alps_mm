...
final class Settings {
    ...
    PackageSetting addPackageLPw(String name, String realName, File codePath, File resourcePath,
            ...
            String cpuAbiOverrideString, int uid, int vc,
            int pkgFlags, int pkgPrivateFlags, int flagsEx) {
    ...
    private PackageSetting getPackageLPw(String name, PackageSetting origPackage,
            ...
            String secondaryCpuAbiString, int vc, int pkgFlags, int pkgPrivateFlags, int flagsEx,
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (idObj != null && idObj instanceof SharedUserSetting) {
                ...
                PackageSetting p = getPackageLPw(pp.name, null, pp.realName,
                        ...
                        pp.secondaryCpuAbiString, pp.versionCode,
                        pp.pkgFlags, pp.pkgPrivateFlags, pp.pkgFlagsEx,
    ...
    private void readDisabledSysPackageLPw(XmlPullParser parser) throws XmlPullParserException,
        ...
        PackageSetting ps = new PackageSetting(name, realName, codePathFile,
                ...
                secondaryCpuAbiStr, cpuAbiOverrideStr, versionCode,
                pkgFlags, pkgPrivateFlags, flagsEx);
