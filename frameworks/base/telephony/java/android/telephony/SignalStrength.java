...
public class SignalStrength implements Parcelable {
    ...
    /**
     * Get real rsrp value without processing invalid value.
     *
     * @return real lte rsrp value
     *
     * @hide
     */
    public int getRealLteRsrp() {
        return mRealLteRsrp;
    }
    ...
    /**
     * Set real rsrp value without processing invalid value.
     *
     * @param realLteRsrp real LTE Rsrp value including invalid value
     * @hide
     */
    public void setRealLteRsrp(int realLteRsrp) {
        mRealLteRsrp = realLteRsrp;
    }
