...
public class PhoneNumberUtils
{
    ...
    private static HashMap<String, Integer> sHashMapForNetworkEccCategory = null;
    ...
    static {
        ...
        sHashMapForNetworkEccCategory = new HashMap<String, Integer>();
    }
    ...
    */
    ...
    public static boolean isEmergencyNumberExt(String number, int phoneType) {
        Rlog.d(LOG_TAG, "[isEmergencyNumberExt], number:" + number + ", phoneType:" + phoneType);
        if (number == null) {
            return false;
        }
        ...
        if (PHONE_TYPE_CDMA == phoneType) {
            ...
            // 1. Check ECCs stored at SIMs
            // Read from SIM1
            String numbers = SystemProperties.get("cdma.ril.ecclist");
            Rlog.d(LOG_TAG, "[isEmergencyNumberExt] cdma.ril.ecclist: " + numbers);
            if (!TextUtils.isEmpty(numbers)) {
                ...
                for (String emergencyNum : numbers.split(",")) {
                    ...
                    if (emergencyNum.equals(number) || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match cdma.ril.ecclist");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            // Read from SIM2
            numbers = SystemProperties.get("cdma.ril.ecclist1");
            Rlog.d(LOG_TAG, "[isEmergencyNumberExt] cdma.ril.ecclist1: " + numbers);
            if (!TextUtils.isEmpty(numbers)) {
                // searches through the comma-separated list for a match,
                // return true if one is found.
                for (String emergencyNum : numbers.split(",")) {
                    numberPlus = emergencyNum + "+";
                    if (emergencyNum.equals(number) || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match cdma.ril.ecclist1");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            // Read from SIM3
            numbers = SystemProperties.get("cdma.ril.ecclist2");
            if (!TextUtils.isEmpty(numbers)) {
                // searches through the comma-separated list for a match,
                // return true if one is found.
                for (String emergencyNum : numbers.split(",")) {
                    numberPlus = emergencyNum + "+";
                    if (emergencyNum.equals(number) || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match cdma.ril.ecclist2");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            // Read from SIM4
            numbers = SystemProperties.get("cdma.ril.ecclist3");
            if (!TextUtils.isEmpty(numbers)) {
                // searches through the comma-separated list for a match,
                // return true if one is found.
                for (String emergencyNum : numbers.split(",")) {
                    numberPlus = emergencyNum + "+";
                    if (emergencyNum.equals(number) || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match cdma.ril.ecclist3");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            // Now CDMA doesn't care if the SIM is inserted or not
            ...
            if (!TextUtils.isEmpty(numbers)) {
                ...
                for (String emergencyNum : numbers.split(",")) {
                    ...
                    if (emergencyNum.equals(number)
                         || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match ril.ecclist2");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            if (!TextUtils.isEmpty(numbers)) {
                ...
                for (String emergencyNum : numbers.split(",")) {
                    ...
                    if (emergencyNum.equals(number)
                         || numberPlus.equals(number)) {
                        Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match ril.ecclist3");
                        return true;
                    }
                }
                bSIMInserted = true;
            ...
            // 4. Check user customized ECC numbers
            try {
                ITelephonyEx telEx = ITelephonyEx.Stub.asInterface(ServiceManager.getService(
                        Context.TELEPHONY_SERVICE_EX));
                if (telEx.isUserCustomizedEcc(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumberExt] match OMH user customized ecc list.");
                    return true;
                }
     ...
     * @hide
     */
    private static void parseEccListFromProperty() {
        ...
        Rlog.d(LOG_TAG, "parseEccListFromProperty: " + sCustomizedEccList);
    }
    ...
    private static void parseEccList() {
        ...
        if (sIsC2kSupport) {
            try {
                ...
                FileReader fileReader = new FileReader(EccEntry.CDMA_ECC_LIST_PATH);
                parser.setInput(fileReader);
                int eventType = parser.getEventType();
                EccEntry record = null;
                while (eventType != XmlPullParser.END_DOCUMENT) {
    ...
    public static int getServiceCategoryFromEcc(String number) {
        ...
        for (String emergencyNum : sHashMapForNetworkEccCategory.keySet()) {
            ...
            if (emergencyNum.equals(number)
                 || numberPlus.equals(number)) {
                Integer nSC = sHashMapForNetworkEccCategory.get(emergencyNum);
                if (nSC != null) {
