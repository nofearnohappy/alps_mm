...
public class SvLteController {
    ...
    /**
     * Whether the srlte feature support.
     *
     * @return the srlte feature support or not
     */
    public static final boolean isMediatekSRLteDcSupport() {
        if ("1".equals(SystemProperties.get(MTK_SRLTE_SUPPORT))) {
            return true;
        } else {
            return false;
        }
    ...
    /**
     * Whether the srlte feature support for the SubscriptionInfo.
     *
     * @param info The SubscriptionInfo.
     * @return the srlte feature support or not
     */
    public static final boolean isMediatekSRLteDcSupport(final SubscriptionInfo info) {
        return info != null && isMediatekSRLteDcSupport() && isSvlteSlot(info.getSimSlotIndex());
    }
