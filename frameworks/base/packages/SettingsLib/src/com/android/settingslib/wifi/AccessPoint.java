...
public class AccessPoint implements Comparable<AccessPoint>, Cloneable {
        ...
        if (isActive() && mConfig != null && mConfig.isPasspoint()) {
            ...
            if (mConfig.autoJoinStatus
                ...
                if (mConfig.disableReason == WifiConfiguration.DISABLED_DHCP_FAILURE) {
                    ...
                    mAccessPointExt.appendApSummary(
                        summary,
                        mConfig.autoJoinStatus,
                        mContext.getString(R.string.wifi_disabled_wifi_failure),
    ...
    public static String getSummary(Context context, String ssid, DetailedState state,
        ...
        if ((state == DetailedState.CONNECTED) && AccessPointExt.getWifiPlugin(context)
            .shouldCheckNetworkCapabilities()) {
