...
public class WifiConfiguration implements Parcelable {
    ...
    ///M: ALPS01975084 sim card absent can't connect EAP-SIM AP
    /** @hide */
    public static final int AUTO_JOIN_DISABLED_EAP_SIM_CARD_ABSENT = 162;
    ///M: ALPS01975084 airplane mode on, should not auto connect EAP SIM
    /** @hide */
    public static final int AUTO_JOIN_DISABLED_EAP_SIM_AIRPLANE_MODE = 163;
...
///M: add start---
    ...
    public String toString() {
        ...
        ///M: EAP_SIM_AKA extends to dual sim
    ...
    */
    ...
    public String configKey(boolean allowCached) {
        ...
        if (allowCached && mCachedConfigKey != null) {
            ...
            ///M: ALPS02021230 3rd party apk use other key to connect WEP @{
            } else if (wepKeys[0] != null || wepKeys[1] != null ||
                    wepKeys[2] != null || wepKeys[3] != null) {
            ///@}
                key = SSID + "WEP";
            ///M: WAPI @{
            } else if (allowedKeyManagement.get(KeyMgmt.WAPI_PSK)) {
